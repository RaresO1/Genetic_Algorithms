...
ofstream g("C:/Users/Rares/Documents/Facultate/An2/Sem1/AG/H_2/results.txt", std::ios_base::app);
//bool v[901], v2[901];


vector<vector<bool>> pop, ofs;
vector<vector<double>> values, ofs_values;
vector<double>eval(200), q_eval(200), p(200), ofs_eval(200);
...
void GA(double (*f1) (vector<vector<bool>> &, vector<vector<double>> &, int), 
    ...
    while(gen_nr != max_gen){ // add break when 100 gen without change
        ...
        double selection_pressure=best_of_gen/2;
        double eps = 1e-5;
